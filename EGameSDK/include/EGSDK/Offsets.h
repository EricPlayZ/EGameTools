...
namespace EGSDK {
	...
	public:
		...
		AddPattern(CGameGlobalSlot, "engine_x64_rwdi.dll", "48 89 05 [?? ?? ?? ?? 48 85 C0 74 ?? 48 89 B8", Utils::SigScan::PatternType::RelativePointer, void*)
		...
		AddDynamicPattern(GetCoPhysics, "gamedll_ph_x64_rwdi.dll", void*)
		...
		AddDynamicPattern(TryGetBaseAIManager, "gamedll_ph_x64_rwdi.dll", void*)
		AddDynamicPattern(BindManagerToBaseAI, "gamedll_ph_x64_rwdi.dll", void*)
