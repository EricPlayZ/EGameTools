...
bool vec4::operator==(const vec4& v) const {
	return EGSDK::Utils::Values::are_samef(X, v.X) && EGSDK::Utils::Values::are_samef(Y, v.Y) && EGSDK::Utils::Values::are_samef(Z, v.Z) && EGSDK::Utils::Values::are_samef(W, v.W);
}
...
bool vec4::isDefault() const {
	return EGSDK::Utils::Values::are_samef(X, 0.0f) && EGSDK::Utils::Values::are_samef(Y, 0.0f) && EGSDK::Utils::Values::are_samef(Z, 0.0f) && EGSDK::Utils::Values::are_samef(W, 0.0f);
}