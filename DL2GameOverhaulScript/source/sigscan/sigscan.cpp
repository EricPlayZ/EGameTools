...
LPVOID PatternScanner::FindPattern(const std::string_view ModuleName, const Pattern &pattern) {
	return PatternScanner::FindPattern(GetModuleHandle(ModuleName.data()), GetModuleSize(ModuleName.data()), pattern);
}
...
std::vector<LPVOID> PatternScanner::FindPatterns(const std::string_view ModuleName, const Pattern &pattern) {
	return PatternScanner::FindPatterns(GetModuleHandle(ModuleName.data()), GetModuleSize(ModuleName.data()), pattern);
}
...
LPVOID PatternScanner::FindPattern(const std::string_view ModuleName, Pattern *patterns, float *ratio) {
	return PatternScanner::FindPattern(GetModuleHandle(ModuleName.data()), GetModuleSize(ModuleName.data()), patterns, ratio);
}